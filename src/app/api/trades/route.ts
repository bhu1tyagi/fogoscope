  ...
  try {
    ...
    const data: TradeRecord[] = trades.map((trade) => {
      ...
      return {
        ...
        slippageBps: trade.slippageBps !== null ? Math.max(0, trade.slippageBps.toNumber()) : null,
        priceImpact: trade.priceImpact !== null ? Math.max(0, trade.priceImpact.toNumber()) : null,
